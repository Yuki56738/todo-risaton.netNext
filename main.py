...
# FontContextManager.add_font(filename='fonts/mplus-2c-regular.ttf')
# FontContextManagerBase.add_font('fonts/mplus-2c-regular.ttf')
# DEFAULT_FONT = 'fonts/mplus-2c-regular.ttf'
# LabelBase.register(DEFAULT_FONT, resource_path())
# if platform == "android":
#     from android.permissions import request_permissions, Permission
#     request_permissions([Permission.READ_EXTERNAL_STORAGE, Permission.WRITE_EXTERNAL_STORAGE])
# DEFAULT_FONT.font_name = 'myfont'
...
class MainApp(MDApp):
    ...
    def on_start(self):
        ...
        # LabelBase.register('myfont', 'fonts/mplus-2c-regular.ttf', 'fonts/mplus-2c-regular.ttf', 'fonts/mplus-2c-regular.ttf', 'fonts/mplus-2c-regular.ttf')
